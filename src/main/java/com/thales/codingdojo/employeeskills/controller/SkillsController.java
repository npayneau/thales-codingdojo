...
public class SkillsController {
    ...
    @Transactional(readOnly = true)
    @GetMapping(value = "/skills/search", produces = {MediaType.APPLICATION_JSON_UTF8_VALUE, MediaType.APPLICATION_XML_VALUE})
    public List<Skill> searchSkills(final String name){
        log.debug("Search skills with name like : {}", name);
