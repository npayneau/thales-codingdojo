...
public class SkillsController {
    ...
    @Transactional(readOnly = true)
    @GetMapping(value = "/skills/{id}", produces = MediaType.APPLICATION_JSON_UTF8_VALUE)
    ...
    @Transactional(readOnly = true)
    @GetMapping(value = "/skills/{id}/employees", produces = MediaType.APPLICATION_JSON_UTF8_VALUE)
    ...
    @Transactional
    @PutMapping(value = "/skills", produces = MediaType.APPLICATION_JSON_UTF8_VALUE)
    ...
    @Transactional
    @DeleteMapping(value = "/skills/{id}", produces = MediaType.APPLICATION_JSON_UTF8_VALUE)
